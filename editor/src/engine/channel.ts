...
export const COLOR_CHANNEL_DESCRIPTIONS: { [channel: string]: ChannelDescription } = {
  'red': {
...
export const ANGLE_CHANNEL_DESCRIPTIONS: Map<keyof FixtureState, ChannelDescription> = new Map();
ANGLE_CHANNEL_DESCRIPTIONS.set(
  'pan',
  {
...
export const ANGLE_CHANNELS = Array.from(ANGLE_CHANNEL_DESCRIPTIONS.keys()) as Array<keyof FixtureState>;
...
export const AMOUNT_CHANNEL_DESCRIPTION: Map<keyof FixtureState, ChannelDescription> = new Map();
AMOUNT_CHANNEL_DESCRIPTION.set(
  'dimmer',
  {
...
export const AMOUNT_CHANNELS = Array.from(AMOUNT_CHANNEL_DESCRIPTION.keys()) as Array<keyof FixtureState>;
