    ...
    <div className={styles.pane}>
      ...
      </Button>
      {
        ...
        <EditFixtureDialog
          ...
          onDelete={() => {
            const name = project.universes[project.activeUniverse.toString()].fixtures[selectedFixtureId.toString()].name;
    ...
    <Modal
      ...
      }
      {
        group.fixtures?.[project.activeUniverse.toString()]?.fixtures.map((id, i) => (
          <div key={id} className={styles.row}>
            {project.universes[project.activeUniverse.toString()].fixtures[id.toString()].name}
            <IconButton
