...
export function DialogProvider({ children }: PropsWithChildren): JSX.Element {
  ...
  const [dismissedReset, setDismissedReset] = useState(
    localStorage.getItem(DIALOG_DISMISSED_KEY) == null,
  );
